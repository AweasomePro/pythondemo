...
import os
# set the default Django Alipaysettings module for the 'celery' program.
from celery import Celery
from chaolifeProject import settings
# set the default Django Alipaysettings module for the 'celery' program.
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'chaolifeProject.settings')

app = Celery('chaolifeProject',)
