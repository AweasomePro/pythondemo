...
See :ref:`apps-Alipaysettings` (in :obj:`shoop.apps`) for general information
about the Shoop Alipaysettings system.  Especially, when inventing Alipaysettings of
your own, the :ref:`apps-naming-Alipaysettings` section is an important read.
"""
