...
#
#
# class RoomPackageSerializer(DynamicModelSerializer):
#
#     class Meta:
#         model = RoomPackage
#         exclude_fields=()
...
#     housePackages = RoomPackageSerializer(many=True,exclude_fields=('room','product'),embed=True)
#     class Meta:
#         model = Room
#
#
...
#     hotel_houses = RoomSerializer(many=True,embed=True,only_fields=('id',))
#     class Meta:
#         model = Hotel
#         name = 'hotel'
#
