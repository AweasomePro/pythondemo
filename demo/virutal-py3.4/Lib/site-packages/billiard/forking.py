...
#
    ...
    class Popen(object):
        '''
        Start a subprocess to run the default_code of a process object
        '''
        _tls = thread._local()
...
def freeze_support():
    '''
    Run default_code for process object if this in not the main process
    '''
...
def main():
    '''
    Run default_code specifed by data received over pipe
    '''
