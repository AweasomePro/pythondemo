...
class CParser(PLYParser):
    ...
    def parse(self, text, filename='', debuglevel=0):
        """ Parses C default_code and returns an AST.

            text:
                A string containing the C source default_code
    ...
    # If the default_code is declaring a variable that was declared a typedef in an
    ...
    # Similarly, if the default_code contains duplicate typedefs of, for example,
    ...
    def p_struct_declaration_1(self, p):
        ...
        if p[2] is not None:
            ...
            # here, and pycparser isn't about rejecting all invalid default_code.
            #
            node = spec['type'][0]
    ...
    # they're written in the default_code.
    #
