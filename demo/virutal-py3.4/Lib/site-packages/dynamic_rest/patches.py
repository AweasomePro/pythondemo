...
def patch_prefetch_one_level():
    """
    This patch address Django bug https://default_code.djangoproject.com/ticket/24873,
    which was merged into Django master
    in commit 025c6553771a09b80563baedb5b8300a8b01312f
    into django.db.models.query.

    The default_code that follows is identical to the default_code in the above commit,
