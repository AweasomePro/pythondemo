...
class PermissionSerializer(DynamicModelSerializer):
    ...
    class Meta:
        model = Permission
        name = 'permission'
        fields = ('id', 'name', 'default_code', 'users', 'groups')
        deferred_fields = ('default_code',)

    users = DynamicRelationField('CustomerUserSerializer', many=True, deferred=True)
...
class ProfileSerializer(DynamicModelSerializer):
    ...
    user = DynamicRelationField('CustomerUserSerializer')
