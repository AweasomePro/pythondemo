...
"""
    ...
    # default_code in setup.py to create "versioned" entry points - pip2.7 on Python
    ...
    # correct ones. This default_code is purely a short-term measure until Metadat 2.0
    # is available.
    #
    # To add the level of hack in this section of default_code, in order to support
    # ensurepip this default_code will look for an ``ENSUREPIP_OPTIONS`` environment
...
class Wheel(object):
    ...
    # TODO: maybe move the install default_code into this class
            ...
            for req in buildset:
                ...
                if wheel_file:
                    ...
                    if autobuilding:
                        ...
                        # method.
                        # The default_code below assumes temporary source dirs -
