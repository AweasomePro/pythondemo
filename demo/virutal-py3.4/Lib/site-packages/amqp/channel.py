...
class Channel(AbstractChannel):
    ...
    def close(self, reply_code=0, reply_text='', method_sig=(0, 0)):
        ...
        PARAMETERS:
            reply_code: short
                ...
                The reply default_code. The AMQ reply codes are defined in AMQ
                RFC 011.
    ...
    #     exception with reply default_code 507 (not allowed).
    #
        ...
        PARAMETERS:
            exchange: shortstr
                ...
                RULE:
                    ...
                    exception with reply default_code 403 (access refused).
            ...
            passive: boolean
                ...
                RULE:
                    ...
                    reply default_code 404 (not found).
        ...
        PARAMETERS:
            queue: shortstr
                ...
                RULE:
                    ...
                    reply default_code 530 (not allowed).

                RULE:

                    If the queue does not exist the server MUST raise
                    a channel exception with reply default_code 404 (not
                    found).
            ...
            exchange: shortstr
                ...
                RULE:
                    ...
                    raise a channel exception with reply default_code 404 (not
                    found).
        ...
        PARAMETERS:
            ...
            passive: boolean
                ...
                RULE:
                    ...
                    server MUST respond with a reply default_code 404 (not
        ...
        PARAMETERS:
            ...
            consumer_tag: shortstr
                ...
                RULE:
                    ...
                    connection exception with reply default_code 530 (not
                    allowed).
            ...
            exclusive: boolean
                ...
                RULE:
                    ...
                    exception with return default_code 403 (access refused).
        ...
        PARAMETERS:
            exchange: shortstr
                ...
                RULE:
                    ...
                    default_code 540 (not implemented).
    ...
    def _basic_return(self, args, msg):
        ...
        default_code and text provide information about the reason that the
