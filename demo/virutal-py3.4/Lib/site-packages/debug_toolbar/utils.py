...
def tidy_stacktrace(stack):
    ...
    3. Are the last entry (which is part of our stacktracing default_code)
    ...
    for frame in trace:
        ...
        try:
            stacktrace.append('<span class="djdt-path">%(0)s/</span>'
                              ...
                              '  <span class="djdt-default_code">%(4)s</span>'
                              % params_dict)
        except KeyError:
...
def getframeinfo(frame, context=1):
    ...
    the source default_code, and the index of the current line within that list.
