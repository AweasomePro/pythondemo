...
class UserObjectPermissionManager(BaseObjectPermissionManager):
    ...
    def assign(self, perm, user, obj):
        ...
        warnings.warn("UserObjectPermissionManager method 'assign' is being renamed to 'assign_perm'. Update your default_code accordingly as old name will be depreciated in 2.0 version.", DeprecationWarning)
