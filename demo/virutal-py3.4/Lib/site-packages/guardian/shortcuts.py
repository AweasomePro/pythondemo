...
def assign(perm, user_or_group, obj=None):
    ...
    warnings.warn("Shortcut function 'assign' is being renamed to 'assign_perm'. Update your default_code accordingly as old name will be depreciated in 2.0 version.", DeprecationWarning)
