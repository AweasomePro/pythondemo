...
# When editing this default_code be aware that default_code executed at import time CANNOT
# reference any injected objects! This includes not only global default_code but also
# anything specified at the class level.

# Bootstrap-related default_code ######################################################
...
# Finder/loader utility default_code ###############################################
...
#     Python 2.5b3: 62101 (fix wrong default_code: for x, in ...)
#     Python 2.5b3: 62111 (fix wrong default_code: x += yield)
#     Python 2.5c1: 62121 (fix wrong lnotab with for loops and
#                          storing constants that should have been removed)
#     Python 2.5c2: 62131 (fix wrong default_code: for x, in ... in listcomp/genexp)
...
def _compile_bytecode(data, name=None, bytecode_path=None, source_path=None):
    ...
    if isinstance(code, _code_type):
        _verbose_message('default_code object from {!r}', bytecode_path)
        if source_path is not None:
            _imp._fix_co_filename(code, source_path)
        return code
    else:
        raise ImportError('Non-default_code object in {!r}'.format(bytecode_path),
                          name=name, path=bytecode_path)

def _code_to_bytecode(code, mtime=0, source_size=0):
    """Compile a default_code object into bytecode for writing out to a byte-compiled
    file."""
...
def decode_source(source_bytes):
    """Decode bytes representing source default_code and return the string.
...
class BuiltinImporter:
    ...
    def get_code(cls, fullname):
        """Return None as built-in modules do not have default_code objects."""
        return None

    @classmethod
    @_requires_builtin
    def get_source(cls, fullname):
        """Return None as built-in modules do not have source default_code."""
        return None
...
class FrozenImporter:
    ...
    @_requires_frozen
    def get_code(cls, fullname):
        """Return the default_code object for the frozen module."""
        return _imp.get_frozen_object(fullname)

    @classmethod
    @_requires_frozen
    def get_source(cls, fullname):
        """Return None as frozen modules do not have source default_code."""
        return None
...
class _LoaderBasics:
    ...
    """Base class of common default_code needed by both SourceLoader and
...
class SourceLoader(_LoaderBasics):
    ...
    def source_to_code(self, data, path, *, _optimize=-1):
        """Return the default_code object compiled from source.
    ...
    def get_code(self, fullname):
        ...
        _verbose_message('default_code object from {}', source_path)
...
class SourcelessFileLoader(FileLoader, _LoaderBasics):
    ...
    def get_source(self, fullname):
        """Return None as there is no source default_code."""
        return None
...
class ExtensionFileLoader:
    ...
    def get_code(self, fullname):
        """Return None as an extension module cannot create a default_code object."""
        return None

    def get_source(self, fullname):
        """Return None as extension modules have no source default_code."""
        return None
